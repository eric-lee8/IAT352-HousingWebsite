...
CREATE TABLE `property` (
  ...
  `date_listed` varchar(100) DEFAULT NULL,
  ...
  CONSTRAINT `Property_ibfk_1` FOREIGN KEY (`agent_ID`) REFERENCES `agents` (`agent_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `property` WRITE;

/*Data for the table `property` */
INSERT INTO `property` (`listing_id`, `beds`, `baths`, `sqft`, `date_listed`, `city`, `address`, `price`, `type`, `agent_ID`) VALUES
